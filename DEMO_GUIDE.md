...
> 当前目标：由 v0.4 直接演进的 v0.7 本地演示版 + 自由指标选择 + DB31/T 1523-2024 指标 + 只读报告诊断 Agent + 评价依据规则 Agent + 待审批规则增强
...
- 规则增强覆盖主键、必填字段、更新时间与更新频率、允许值、数值闭区间五类白名单规则；不接受正则、表达式、代码或模型自定义规则；
